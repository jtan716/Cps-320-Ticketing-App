...
namespace TicketingAppProject.Services
{
     ...
     * @Source: taken from Dr. Schaub ListDemos example that's taken from https://updatecontrols.net/doc/node/39.html
     * @Summary: Takes a target object (usually list) and converts it to an observable collection. For MVVM binding. 
     */
